...
<script>
    ...
    $('#category_form').on('submit', function(e) {
        ...
        var url = '{{ URL::to('/user/setting/category/store') }}';
        // alert(url);
        $.ajax({
            url: url,
            method: 'POST',
       ...
       $(document).on('click','.edit',function(e){
        e.preventDefault();
       var id = $(this).data('id');
       var url = '{{URL::to('user/setting/category/edit')}}';
       $.ajax({
            url:url,
            type:'get',
            data:{
    ...
    $('#edit_category_form').on('submit', function(event) {
        ...
        if ($('#edit_category_form').valid()) {
            ...
            var url = '{{ URL::to('user/setting/category/update') }}';
            $.ajax({
                url: url,
                type: "POST",
                data: formData,
    ...
    //update category using ajax end
      ...
      $(document).on('click', '.delete', function() {
        var id = $(this).data('id');
        var url = '{{ URL::to('user/setting/category/delete') }}';
        Swal.fire({
            title: 'Are you sure?',
    ...
    $(document).ready(function() {
        $('.category_status').click(function(e) {
            e.preventDefault();
            var id = $(this).data('id');
            var ajaxurl = '{{ URL::to('user/setting/category/status') }}';
            Swal.fire({
                title: 'Are you sure?',
