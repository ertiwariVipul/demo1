    ...
    <div class="modal fade text-left" id="userProfile" tabindex="-1" role="dialog" aria-labelledby="RditProduct"
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <form method="post" id="editProfileForm" action="{{route('user.profileEdit')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="modal-body">
                        <!-- <label>First  Name</label>
                        <div class="form-group">
                            <input type="text" placeholder="Enter your First Name" class="form-control" name="userFirstName"
                             value="{{@Auth::user()->firstName}}"   id="userFirstName">
                        </div>
                        <label>Middle Name</label>
                        <div class="form-group">
                            <input type="text" placeholder="Enter your middle Name" class="form-control" name="userMiddleName"
                             value="{{@Auth::user()->middleName}}"   id="userMiddleName">
                        </div>
                        <label>Last Name</label>
                        <div class="form-group">
                            <input type="text" placeholder="Enter your Name" class="form-control" name="userLastName"
                             value="{{@Auth::user()->lastName}}"   id="userLastName">
                        </div> -->
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <label>City</label>
                                <div class="form-group">
                                    <input type="text" placeholder="Enter your city Name" class="form-control" name="userCity"
                                    value="{{@Auth::user()->city}}"   id="userCity">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <label>Country</label>
                                <div class="form-group">
                                    <input type="text" placeholder="Enter your Country Name" class="form-control" name="userCountry"
                                    value="{{@Auth::user()->country}}"   id="userContry">
                                </div>
                            </div>
                            <div class="col-12">
                                <label>Image</label>
