<div class="card">
    <div class="card-body">
        <form id="form-event-admin" class="form-horizontal form-wizard-wrapper formEvent" method="POST"
            ...
            <fieldset class="position-relative">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Date</label>
                            <input type="date" class="form-control visa_date" name="date" id="event-date" placeholder="Event Date" value="{{ @$event->date }}" />
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Starting Time</label>
                            <input type="time" class="form-control" name="startTime" id="event-start-time"
                                placeholder="Select Event Start Time" value="{{ @$event->startTime }}" />
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Ending Time</label>
                            <input type="time" class="form-control" name="endTime" id="event-ending-time"
                                placeholder="Select Event Ending Time" value="{{ @$event->endTime }}" />
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="location" id="event-location"
                                placeholder="You Event Location" value="{{ @$event->location }}" />
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" placeholder="Write Event Description here" rows="5" cols="5"
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            ?>
                            <select class="storeMultiple form-control select2-multiple" style="width: 350px"
                                name="category[]" id="category" multiple data-placeholder="Choose..">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="noOfGirls" id="event-no-of-girls"
                                placeholder="Enter Number Of Girls" readonly
                                    ...
                                    <div class='image-wrapper'>
                                        <div class="custom-checkbox-wrap">
                                            <div class="custom-checkbox">
                                                ...
                                                <label class="custom-checkbox-label" for="model-{{ @$modelItem['users']['id'] }}"></label>
                                            </div>
                                        </div>
